...
/**
 * OlxstatisticSearch represents the model behind the search form about `common\models\Olxstatistic`.
 */
class OlxstatisticSearch extends Olxstatistic
{
    /**
     * @inheritdoc
     */
